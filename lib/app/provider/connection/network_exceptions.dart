...
String getErrorMessage(NetworkExceptions networkExceptions, {
  bool handleUnauthorisedRequest = false,
}) {
  var errorMessage = 'Un Expected Error'.tr;
  networkExceptions.when(
    notImplemented: () {}, // () => errorMessage = 'Not Implemented',
    requestCancelled: () {}, // () => errorMessage = 'Request Cancelled',
    internalServerError: () => errorMessage = 'Internal Server Error'.tr,
    ...
    unauthorisedRequest: () => handleUnauthorisedRequest ? 'Invalid Phone Number or Password'.tr : errorMessage = 'Unauthorised request',
    unexpectedError: () => errorMessage = 'Unexpected error occurred',
    requestTimeout: () {}, // () => errorMessage = 'Connection request timeout',
    noInternetConnection: () => errorMessage = 'No Internet Connection'.tr,
